...
def download_files_from_google_drive(folder_name, dest_path='Videos', query_style="mimeType contains 'image/'") -> bool:
    """
    ...
    :param query_style: file style to search
    ...
    file_query = "{} and '{}' in parents".format(query_style, folder_id)
